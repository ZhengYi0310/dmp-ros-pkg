/*************************************************************************
	> File Name: quaternion_utilities.h
	> Author: Yi Zheng 
	> Mail: hczhengcq@gmail.com
	> Created Time: Mon 31 Oct 2016 08:10:26 PM PDT
 ************************************************************************/

#ifndef _QUATERNION_UTILITIES_H
#define _QUATERNION_UTILITIES_H
...
namespace dmp_lib
{
     ...
     * REAL-TIME REQUIREMENTS
     */
    void getQMatrix(const Eigen::Vector4d& quat, Eigen::Matrix<double, 4, 3>& Q);
    ...
    inline void getQMatrix(const Eigen::Vector4d& quat, Eigen::Matrix<double, 4, 3>& Q)
    {
        Q(0, 0) = -quat(1);
        Q(0, 1) = -quat(2);
        Q(0, 2) = -quat(3);
