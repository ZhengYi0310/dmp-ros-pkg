/*************************************************************************
	...
	> Created Time: Thu 27 Oct 2016 03:31:30 PM PDT
 ************************************************************************/
...
namespace dmp_lib
{
    ...
    class Trajectory : public Status 
    {
        public:
            ...
            /*!
             */
            Trajectory() : positions_only_(false), trajectory_length_(0), trajectory_dimension_(0), index_to_last_trajectory_point_(0), sampling_frequency_(0.0), trajectory_duration_(0.0) {};
            ...
            /*! Initialize the trajectory from the File pointed to by the provided file_name
             * @param file_name 
             * @param positions_only
             * @return true on success, otherwise false 
             */
            bool readFromCLMCFile(const std::string& file_name, const bool positions_only = false);
