/*************************************************************************
	...
	> Author: 
	> Mail: 
	> Created Time: Tue 18 Oct 2016 04:04:28 PM PDT
 ************************************************************************/
...
namespace dmp_lib 
{
    ...
    class State 
    {
        public:
            ...
            /*! Constructor
             */
            State() : x_(0), xd_(0), xdd_(0) {};
            State(const double x, const double xd, const double xdd) : x_(x), xd_(xd), xdd_(xdd) {};
            ...
            {
                return ((fabs(x_ - state.x_) < EQUALITY_PRECISSION) && (fabs(xd_ - state.xd_) < EQUALITY_PRECISSION) && (fabs(xdd_ - state.xdd_) < EQUALITY_PRECISSION));
            }
