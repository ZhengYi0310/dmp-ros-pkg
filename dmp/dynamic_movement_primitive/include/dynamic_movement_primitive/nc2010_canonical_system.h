/*************************************************************************
	...
	> Created Time: Mon 14 Nov 2016 07:34:50 PM PST
 ************************************************************************/
...
namespace dmp 
{
    ...
    {
        /*! Allow the NC2010DynamicMovementPrimitive class to access private member variables directly
         */
        ...
        public:
             ...
             */
            static bool initFromNodeHandle(dmp_lib::NC2010CSPtr& canonical_system, ros::NodeHandle& node_handle);
