/*************************************************************************
	...
	> Created Time: Mon 14 Nov 2016 07:53:15 PM PST
 ************************************************************************/
    ...
    class NC2010TransformationSystem
    {
        ...
        public:
            ...
            */
             ...
             * @return True if success, otherwise False
             */
            static bool initFromMessage(std::vector<dmp_lib::NC2010TSPtr>& transformation_systems, const std::vector<NC2010TSMsg>& ts_msgs);
             ...
             * @return True if success, otherwise False
             */
            static bool writeToMessage(const std::vector<dmp_lib::NC2010TSConstPtr> transformation_systems, std::vector<NC2010TSMsg>& ts_msgs);
