/*************************************************************************
	> File Name: skill_library.cpp
	> Author: Yi Zheng 
	> Mail: hczhengcq@gmail.com
	> Created Time: Fri 23 Dec 2016 09:08:42 PM PST
 ************************************************************************/
...
namespace skill_library
{
    ...
    bool SkillLibrary::getAffordance(getAffordance::Request& request, getAffordance::Response& response)
    {
        ...
        if(!dmp_library_client_.getDMP(request.affordance.object.name, response.affordance.dmp.nc2010_dmp))
        {
