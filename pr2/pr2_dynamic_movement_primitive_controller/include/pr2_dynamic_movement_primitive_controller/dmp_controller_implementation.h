/*************************************************************************
	...
	> Created Time: Fri 06 Jan 2017 11:59:09 AM PST
 ************************************************************************/
...
#include "pr2_dynamic_movement_primitive_controller/filtered_subscriber.h"
...
namespace pr2_dynamic_movement_primitive_controller
{
                                                          ...
                                                          const std::vector<std::string>& dmp_variable_names)
    {
        ...
        {
            ROS_ERROR("%s: Cannot initialize dmp controller with no vairable names.", controller_name.c_str());
            return false;
        }

        ROS_DEBUG("Intializing DMP controller >%s< with the following variable names:", controller_name.c_str());
