/*************************************************************************
	...
	> Created Time: Sat 07 Jan 2017 12:01:40 PM PST
 ************************************************************************/
...
{
    DMPIkController::DMPIkController() : initialized_(false), publishing_rate_(15), publishing_counter_(0), publisher_buffer_size_(0), visualization_line_counter_(0), visualization_line_rate_(10), visualization_line_max_points_(20), publishing_seq_counter_(0), keep_restposture_fixed_for_testing_(false), last_frame_set_(false), num_joints_(0)
    {
        robot_info::RobotInfo::initialize();
    }

    bool DMPIkController::init(pr2_mechanism_model::RobotState* robot_state,
    ...
    bool DMPIkController::getArmRelatedVariables(const std::string& handle_namespace,
